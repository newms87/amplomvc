...
$_['entry_type']         = 'Type:';
$_['entry_value']        = 'Option Value:';
$_['entry_display_value'] = "Option Value Display:<span class=\"help\">The value to show to customers.<br/>Leave blank to use Option Value. HTML enabled.</span>";
$_['entry_image']        = 'Image:';

...
// Entry
$_['entry_button_graphic']           = "Image Title:<span class=\"help\">The Paypal Button Graphic image to replace the Paypal title during checkout. Leave blank to use default title.</span>";

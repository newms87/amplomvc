				...
				<table id="module" class="list">
					...
					<? foreach ($modules as $module) { ?>
						...
						<tr>
							...
							<td class="left"><input type="text" name="slideshow_module[<?= $module_row; ?>][width]"
							                        value="<?= $module['width']; ?>" size="3"/>
								<input type="text" name="slideshow_module[<?= $module_row; ?>][height]"
							...
							<td class="right"><input type="text" name="slideshow_module[<?= $module_row; ?>][sort_order]"

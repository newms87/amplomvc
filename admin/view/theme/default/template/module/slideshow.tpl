			...
			<table id="module" class="list">
				<thead>
					<tr>
						...
						<td class="left"><?= $entry_dimension; ?></td>
				...
				<tbody id="module-row<?= $module_row; ?>">
					<tr>
						<td class="left"><select name="slideshow_module[<?= $module_row; ?>][banner_id]">
						...
						<td class="left"><input type="text" name="slideshow_module[<?= $module_row; ?>][width]" value="<?= $module['width']; ?>" size="3" />
							...
							<? } ?></td>
						<td class="left"><select name="slideshow_module[<?= $module_row; ?>][layout_id]">
						...
						<td class="left"><select name="slideshow_module[<?= $module_row; ?>][position]">
						...
						<td class="left"><select name="slideshow_module[<?= $module_row; ?>][status]">
								<? if ($module['status']) { ?>
						...
						<td class="right"><input type="text" name="slideshow_module[<?= $module_row; ?>][sort_order]" value="<?= $module['sort_order']; ?>" size="3" /></td>

      ...
      <form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table id="module" class="list">
          ...
          <tbody id="module-row<?= $module_row; ?>">
            <tr>
              <td class="left"><input type="text" name="special_module[<?= $module_row; ?>][limit]" value="<?= $module['limit']; ?>" size="1" /></td>
              <td class="left"><input type="text" name="special_module[<?= $module_row; ?>][image_width]" value="<?= $module['image_width']; ?>" size="3" />
                <input type="text" name="special_module[<?= $module_row; ?>][image_height]" value="<?= $module['image_height']; ?>" size="3" />
                <? if (isset($error_image[$module_row])) { ?>
                <span class="error"><?= $error_image[$module_row]; ?></span>
                <? } ?></td>
              <td class="left"><select name="special_module[<?= $module_row; ?>][layout_id]">
              ...
              <td class="left"><select name="special_module[<?= $module_row; ?>][position]">
              ...
              <td class="left"><select name="special_module[<?= $module_row; ?>][status]">
                  <? if ($module['status']) { ?>
              ...
              <td class="right"><input type="text" name="special_module[<?= $module_row; ?>][sort_order]" value="<?= $module['sort_order']; ?>" size="3" /></td>

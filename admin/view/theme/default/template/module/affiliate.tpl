    ...
    <form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table id="module" class="list">
        ...
        <tbody id="module-row<?= $module_row; ?>">
          <tr>
            <td class="left"><select name="affiliate_module[<?= $module_row; ?>][layout_id]">
            ...
            <td class="left"><select name="affiliate_module[<?= $module_row; ?>][position]">
            ...
            <td class="left"><select name="affiliate_module[<?= $module_row; ?>][status]">
                <? if ($module['status']) { ?>
            ...
            <td class="right"><input type="text" name="affiliate_module[<?= $module_row; ?>][sort_order]" value="<?= $module['sort_order']; ?>" size="3" /></td>

			...
			<form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<table id="module" class="list">
					...
					<? foreach ($modules as $module) { ?>
						...
						<tr>
							<td class="left"><select name="category_module[<?= $module_row; ?>][layout_id]">
							...
							<td class="left"><select name="category_module[<?= $module_row; ?>][position]">
							...
							<td class="left"><select name="category_module[<?= $module_row; ?>][count]">
									<? if ($module['count']) { ?>
							...
							<td class="left"><select name="category_module[<?= $module_row; ?>][status]">
									<? if ($module['status']) { ?>
										<option value="1" selected="selected"><?= $text_enabled; ?></option>
										<option value="0"><?= $text_disabled; ?></option>
									<? } else { ?>
							...
							<td class="right"><input type="text" name="category_module[<?= $module_row; ?>][sort_order]" value="<?= $module['sort_order']; ?>" size="3"/></td>

			...
			<table id="module" class="list">
				...
				<tbody id="module-row<?= $module_row; ?>">
					<tr>
						...
						<td class="left"><?= $this->builder->build('select',$statuses, "flashsale_sidebar_module[$module_row][status]", (int)$module['status']); ?></td>
...
function addModule() {
	...
	html += '	<tr>';
	html += '		<td class="left"><input type="text" name="flashsale_sidebar_module[%modrow%][limit]" value="5" size="1" maxlength="2" /></td>';
	html += '		<td class="left">' + "<?= $this->builder->build('select',$layouts,'flashsale_sidebar_module[%modrow%][layout_id]'); ?>" + '</td>';
	html += '		<td class="left">' + "<?= $this->builder->build('select',$positions,'flashsale_sidebar_module[%modrow%][position]'); ?>" + '</td>';
	html += '		<td class="left">' + "<?= $this->builder->build('select',$statuses, 'flashsale_sidebar_module[%modrow%][status]'); ?>" + '</td>';
	html += '		<td class="right"><input type="text" name="flashsale_sidebar_module[%modrow%][sort_order]" size="3" /></td>';

			...
			<form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<table class="form">
					<tr>
						...
						<td><?= $this->builder->build('select', $designers, 'designer', null, array('id' => 'designer_list')); ?>
							<a onclick='add_selected_designer();' class='button designer'>Add Designer</a></td>
					</tr>
					<tr>
				...
				<table id="module" class="list">
					...
					<? foreach ($modules as $module) { ?>
						...
						<tr>
							...
							<td
								class='left'><?= $this->builder->build('select', $layouts, "featured_flashsale_module[$module_row][layout_id]", (int)$module['layout_id']); ?></td>
							<td

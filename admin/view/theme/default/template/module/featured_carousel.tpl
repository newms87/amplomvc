		...
		<div class="content">
			<form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<table class="form" style="border-bottom: black 2px solid">
					<tr>
						<td>
							<div><?= $entry_featured_items; ?></div>
							<br/>

							<div>
								<input type="text" class="autocomplete" for='featured_product_list' filter='filter_name'
								       route='catalog/product/autocomplete'/><br/>
								<?= $text_autocomplete; ?>
							</div>
						</td>
						<td>
				...
				<table class="form">
					<tr>
						<td>
							<div><?= $entry_carousel_blocks; ?></div>
							<br/>

							<div>
								<input type="text" class="autocomplete" for='featured_carousel_list' filter='filter_name'
								       route='catalog/product/autocomplete'/><br/>
								<?= $text_autocomplete; ?>
							</div>
						</td>

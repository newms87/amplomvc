		...
		<div class="content">
			<form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<table class="form">
					...
					<tr>
						<td><?= $entry_total; ?></td>
						<td><input type="text" name="pp_express_total" value="<?= $pp_express_total; ?>" /></td>
					</tr>
					<tr>
						<td><?= $entry_order_status; ?></td>
						<td><select name="pp_express_order_status_id">
								<? foreach ($order_statuses as $order_status) { ?>
								<? if ($order_status['order_status_id'] == $pp_express_order_status_id) { ?>
					...
					<tr>
						...
						<td><select name="pp_express_geo_zone_id">
								...
								<? if ($geo_zone['geo_zone_id'] == $pp_express_geo_zone_id) { ?>
					...
					<tr>
						...
						<td><input type="text" name="pp_express_sort_order" value="<?= $pp_express_sort_order; ?>" size="1" /></td>
					</tr>
				</table>
			</form>
		</div>

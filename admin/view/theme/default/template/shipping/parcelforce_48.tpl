		...
		<div class="content">
			<form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<table class="form">
					<tr>
						<td><?= $entry_rate; ?></td>
						<td><textarea name="parcelforce_48_rate" cols="40" rows="5"><?= $parcelforce_48_rate; ?></textarea></td>
					</tr>
					<tr>
						<td><?= $entry_insurance; ?></td>
						<td><textarea name="parcelforce_48_insurance" cols="40" rows="5"><?= $parcelforce_48_insurance; ?></textarea></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="parcelforce_48_sort_order" value="<?= $parcelforce_48_sort_order; ?>" size="1" /></td>
					</tr>
				</table>
			</form>
		</div>

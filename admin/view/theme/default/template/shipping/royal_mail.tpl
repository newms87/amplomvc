			...
			<form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
				...
				<div id="tab-1st-class-standard" class="vtabs-content">
					<table class="form">
						<tr>
							<td><?= $entry_rate; ?></td>
							<td><textarea name="royal_mail_1st_class_standard_rate" cols="40" rows="5"><?= $royal_mail_1st_class_standard_rate; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_insurance; ?></td>
							<td><textarea name="royal_mail_1st_class_standard_insurance" cols="40" rows="5"><?= $royal_mail_1st_class_standard_insurance; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_status; ?></td>
				...
				<div id="tab-1st-class-recorded" class="vtabs-content">
					<table class="form">
						<tr>
							<td><?= $entry_rate; ?></td>
							<td><textarea name="royal_mail_1st_class_recorded_rate" cols="40" rows="5"><?= $royal_mail_1st_class_recorded_rate; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_insurance; ?></td>
							<td><textarea name="royal_mail_1st_class_recorded_insurance" cols="40" rows="5"><?= $royal_mail_1st_class_recorded_insurance; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_status; ?></td>
				...
				<div id="tab-2nd-class-standard" class="vtabs-content">
					<table class="form">
						<tr>
							<td><?= $entry_rate; ?></td>
							<td><textarea name="royal_mail_2nd_class_standard_rate" cols="40" rows="5"><?= $royal_mail_2nd_class_standard_rate; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_status; ?></td>
				...
				<div id="tab-2nd-class-recorded" class="vtabs-content">
					<table class="form">
						<tr>
							<td><?= $entry_rate; ?></td>
							<td><textarea name="royal_mail_2nd_class_recorded_rate" cols="40" rows="5"><?= $royal_mail_2nd_class_recorded_rate; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_insurance; ?></td>
							<td><textarea name="royal_mail_2nd_class_recorded_insurance" cols="40" rows="5"><?= $royal_mail_2nd_class_recorded_insurance; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_status; ?></td>
				...
				<div id="tab-special-delivery-500" class="vtabs-content">
					<table class="form">
						<tr>
							<td><?= $entry_rate; ?></td>
							<td><textarea name="royal_mail_special_delivery_500_rate" cols="40" rows="5"><?= $royal_mail_special_delivery_500_rate; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_insurance; ?></td>
							<td><textarea name="royal_mail_special_delivery_500_insurance" cols="40" rows="5"><?= $royal_mail_special_delivery_500_insurance; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_status; ?></td>
				...
				<div id="tab-special-delivery-1000" class="vtabs-content">
					<table class="form">
						<tr>
							<td><?= $entry_rate; ?></td>
							<td><textarea name="royal_mail_special_delivery_1000_rate" cols="40" rows="5"><?= $royal_mail_special_delivery_1000_rate; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_insurance; ?></td>
							<td><textarea name="royal_mail_special_delivery_1000_insurance" cols="40" rows="5"><?= $royal_mail_special_delivery_1000_insurance; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_status; ?></td>
				...
				<div id="tab-special-delivery-2500" class="vtabs-content">
					<table class="form">
						<tr>
							<td><?= $entry_rate; ?></td>
							<td><textarea name="royal_mail_special_delivery_2500_rate" cols="40" rows="5"><?= $royal_mail_special_delivery_2500_rate; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_insurance; ?></td>
							<td><textarea name="royal_mail_special_delivery_2500_insurance" cols="40" rows="5"><?= $royal_mail_special_delivery_2500_insurance; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_status; ?></td>
				...
				<div id="tab-standard-parcels" class="vtabs-content">
					<table class="form">
						<tr>
							<td><?= $entry_rate; ?></td>
							<td><textarea name="royal_mail_standard_parcels_rate" cols="40" rows="5"><?= $royal_mail_standard_parcels_rate; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_insurance; ?></td>
							<td><textarea name="royal_mail_standard_parcels_insurance" cols="40" rows="5"><?= $royal_mail_standard_parcels_insurance; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_status; ?></td>
				...
				<div id="tab-airmail" class="vtabs-content">
					<table class="form">
						<tr>
							...
							<td><textarea name="royal_mail_airmail_rate_1" cols="40" rows="5"><?= $royal_mail_airmail_rate_1; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_airmail_rate_2; ?></td>
							<td><textarea name="royal_mail_airmail_rate_2" cols="40" rows="5"><?= $royal_mail_airmail_rate_2; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_status; ?></td>
				...
				<div id="tab-international-signed" class="vtabs-content">
					<table class="form">
						<tr>
							...
							<td><textarea name="royal_mail_international_signed_rate_1" cols="40" rows="5"><?= $royal_mail_international_signed_rate_1; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_international_signed_insurance_1; ?></td>
							<td><textarea name="royal_mail_international_signed_insurance_1" cols="40" rows="5"><?= $royal_mail_international_signed_insurance_1; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_international_signed_rate_2; ?></td>
							<td><textarea name="royal_mail_international_signed_rate_2" cols="40" rows="5"><?= $royal_mail_international_signed_rate_2; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_international_signed_insurance_2; ?></td>
							<td><textarea name="royal_mail_international_signed_insurance_2" cols="40" rows="5"><?= $royal_mail_international_signed_insurance_2; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_status; ?></td>
				...
				<div id="tab-airsure" class="vtabs-content">
					<table class="form">
						<tr>
							...
							<td><textarea name="royal_mail_airsure_rate_1" cols="40" rows="5"><?= $royal_mail_airsure_rate_1; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_airsure_insurance_1; ?></td>
							<td><textarea name="royal_mail_airsure_insurance_1" cols="40" rows="5"><?= $royal_mail_airsure_insurance_1; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_airsure_rate_2; ?></td>
							<td><textarea name="royal_mail_airsure_rate_2" cols="40" rows="5"><?= $royal_mail_airsure_rate_2; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_airsure_insurance_2; ?></td>
							<td><textarea name="royal_mail_airsure_insurance_2" cols="40" rows="5"><?= $royal_mail_airsure_insurance_2; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_status; ?></td>
				...
				<div id="tab-surface" class="vtabs-content">
					<table class="form">
						<tr>
							<td><?= $entry_rate; ?></td>
							<td><textarea name="royal_mail_surface_rate" cols="40" rows="5"><?= $royal_mail_surface_rate; ?></textarea></td>
						</tr>
						<tr>
							<td><?= $entry_status; ?></td>

...
<div class="content">
	...
	<div class="box">
		<div class="heading">
			<h1><img src="<?= HTTP_THEME_IMAGE . 'measurement.png'; ?>" alt="" /> <?= $heading_title; ?></h1>
			...
			<form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
				...
				<table class="form">
					...
					<tr>
						...
						<td><input type="text" name="measurement_rule[<?= $measurement_to['measurement_class_id']; ?>]" value="<?= isset($measurement_rule[$measurement_to['measurement_class_id']]) ? $measurement_rule[$measurement_to['measurement_class_id']]['rule'] : ''; ?>" /></td>
					</tr>
					<? } ?>
				</table>
			</form>

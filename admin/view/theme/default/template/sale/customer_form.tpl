...
<script type="text/javascript"><
	...
	function addAddress() {
		...
		$('#address-add').before('<a href="#tab-address-' + address_row + '" id="address-' + address_row + '"><?= _l("Address"); ?> ' + address_row + '&nbsp;<img src="<?= HTTP_THEME_IMAGE . 'delete.png'; ?>" alt="" onclick="$(\'#vtabs a:first\').trigger(\'click\'); $(\'#address-' + address_row + '\').remove(); $(\'#tab-address-' + address_row + '\').remove(); return false;" /></a>');
...
<script type="text/javascript"><
	...
	function addTransaction() {
		...
		beforeSend: function () {
			...
			$('#transaction').before('<div class="attention"><img src="<?= HTTP_THEME_IMAGE . 'loading.gif'; ?>" alt="" /> <?= _l("Please Wait!"); ?></div>');
		}
	,
		complete: function () {
...
<script type="text/javascript"><
	...
	function addRewardPoints() {
		...
		beforeSend: function () {
			...
			$('#reward').before('<div class="attention"><img src="<?= HTTP_THEME_IMAGE . 'loading.gif'; ?>" alt="" /> <?= _l("Please Wait!"); ?></div>');
		}
	,
		complete: function () {

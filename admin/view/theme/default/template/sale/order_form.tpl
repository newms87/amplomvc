					...
					<table class="list">
						...
						<tbody id="product">
							...
							<tr id="product-row<?= $product_row; ?>">
								<td class="center" style="width: 3px;"><img src="<?= HTTP_THEME_IMAGE . 'delete.png'; ?>" title="<?= $button_remove; ?>" alt="<?= $button_remove; ?>" style="cursor: pointer;" onclick="$('#product-row<?= $product_row; ?>').remove(); $('#button-update').trigger('click');" /></td>
					...
					<table class="list">
						...
						<tbody id="voucher">
							...
							<tr id="voucher-row<?= $voucher_row; ?>">
								<td class="center" style="width: 3px;"><img src="<?= HTTP_THEME_IMAGE . 'delete.png'; ?>" title="<?= $button_remove; ?>" alt="<?= $button_remove; ?>" style="cursor: pointer;" onclick="$('#voucher-row<?= $voucher_row; ?>').remove(); $('#button-update').trigger('click');" /></td>

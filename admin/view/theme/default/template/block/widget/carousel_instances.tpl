<? foreach ($instances as $row => $instance) { ?>
	...
	<div class="instance vtabs-content" data-extend="tab-instance-<?= $row; ?>">
		...
		<table class="form nivo slider_settings">
			<tr>
				<td><?= _l("Pause Time"); ?></td>
				<td><input type="text" size="2" name="<?= $row_name; ?>[nivo][pauseTime]" value="<?= $settings['nivo']['pauseTime']; ?>"/></td>
			</tr>
			<tr>
				<td><?= _l("Animation Speed"); ?></td>
				<td><input type="text" size="2" name="<?= $row_name; ?>[nivo][animSpeed]" value="<?= $settings['nivo']['animSpeed']; ?>"/></td>
			</tr>
		</table>
		...
		<table class="form slidesjs slider_settings">
			<tr>
				<td><?= _l("Width"); ?></td>
				<td><input type="text" size="2" name="<?= $row_name; ?>[slidesjs][width]" value="<?= $settings['slidesjs']['width']; ?>" /></td>
			</tr>
			<tr>
				<td><?= _l("Height"); ?></td>
				<td><input type="text" size="2" name="<?= $row_name; ?>[slidesjs][height]" value="<?= $settings['slidesjs']['height']; ?>" /></td>
			</tr>
			<tr>
				<td><?= _l("Starting Slide"); ?></td>
				<td><input type="text" size="2" name="<?= $row_name; ?>[slidesjs][start]" value="<?= $settings['slidesjs']['start']; ?>" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" size="4" name="<?= $row_name; ?>[slidesjs][play][interval]" value="<?= $settings['slidesjs']['play']['interval']; ?>" /></td>
			</tr>
			<tr>
				<td><?= _l("Restart Delay (if inactive) (ms)"); ?></td>
				<td><input type="text" size="4" name="<?= $row_name; ?>[slidesjs][play][restartDelay]" value="<?= $settings['slidesjs']['play']['restartDelay']; ?>" /></td>
			</tr>
			<tr>
				<td><?= _l("Fade Effect Speed"); ?></td>
				<td><input type="text" size="2" name="<?= $row_name; ?>[slidesjs][effect][fade][speed]" value="<?= $settings['slidesjs']['effect']['fade']['speed']; ?>" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" size="2" name="<?= $row_name; ?>[slidesjs][effect][slide][speed]" value="<?= $settings['slidesjs']['effect']['slide']['speed']; ?>" /></td>
			</tr>
		</table>

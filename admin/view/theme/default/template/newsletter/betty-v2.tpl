    ...
    <tr>
      <td style="border: solid 1px #cccccc;">
         <table style="width: 795px; border-collapse: collapse;" border="0" cellpadding="0" cellspacing="0">
            ...
            <tbody>
               <tr>
                  <td style="padding-bottom: 5px;" align="center" width="795"><img style="border: 0pt none;" title="divider" alt="divider" src="http://bettyconfidential.img-us3.com/admin/bc_shop_v2/divider.jpg" height="18" width="775"></td>
               </tr>
            </tbody>
            <tbody>
               <tr>
                  ...
                  <td style="padding-left: 0px; padding-top: 10px; padding-bottom: 10px;" valign="top"><!-- LEFT COLUMN START --> <!-- ROW 1 ITEMS -->
                     ...
                     <table style="width: 495px; border-collapse: collapse;" cellpadding="0" cellspacing="0">
                        <tbody>
                           <tr>
                           <? for($c=0; $c<3; $c++){?>
                              <? if(empty($newsletter['products'])) break; ?>
                              <? $product = array_shift($newsletter['products']); ?>
                              <td style="<?=$c>0?'padding-left:11px;':'padding-left:7px;'?> padding-top: 0px; padding-bottom: 10px;">
                                 <table style="border-collapse: collapse; width: 165px;" cellpadding="0" cellspacing="0">
                                    <tbody>
                                       <tr>
         ...
         <tbody>
         <tr>
         <td align="center" width="795"><img style="border: 0pt none;" title="divider" alt="divider" src="http://bettyconfidential.img-us3.com/admin/bc_shop_v2/divider.jpg" height="18" width="775"></td>
         </tr>
         </tbody>
         </table>
         ...
         <table style="width: 795px; border-collapse: collapse;" border="0" cellpadding="0" cellspacing="0">
            <tbody>
               ...
               <tr>
                  <? for($c=0; $c<5; $c++){ ?>
                  <? if(empty($newsletter['designers'])) break; ?>

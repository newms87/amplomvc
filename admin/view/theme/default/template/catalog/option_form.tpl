			...
			<form action="<?= $save; ?>" method="post" enctype="multipart/form-data" id="form">
				...
				<table class="list">
					...
					<tfoot>
						<tr>
							<td colspan="3"></td>
							<td class="left"><a onclick="add_option_value();" class="button"><?= $button_add_option_value; ?></a></td>
						</tr>
					</tfoot>
				</table>
			</form>
...
$('#option_value_list').sortable({cursor: "move", stop: function(){$('#option_value_list').update_index();} });
//--></script>

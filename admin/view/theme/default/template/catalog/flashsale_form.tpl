				...
				<div id="tab-general">
					...
					<tr>
						...
						<tr>
							...
							<td><input type="text" class="datetimepicker" name="date_start" value="<?= $date_start; ?>" size="20" /></td>
						</tr>
						<tr>
							<td class="required"> <?= $entry_date_end; ?></td>
							<td><input type="text" class="datetimepicker" name="date_end" value="<?= $date_end; ?>" size="20" /></td>
						</tr>
						<tr>

      ...
      <form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="sagepay_direct_vendor" value="<?= $sagepay_direct_vendor; ?>" />
              <? if ($error_vendor) { ?>
          ...
          <tr>
            <td><?= $entry_total; ?></td>
            <td><input type="text" name="sagepay_direct_total" value="<?= $sagepay_direct_total; ?>" /></td>
          </tr>          
          <tr>
            <td><?= $entry_order_status; ?></td>
            <td><select name="sagepay_direct_order_status_id">
                <? foreach ($order_statuses as $order_status) { ?>
                <? if ($order_status['order_status_id'] == $sagepay_direct_order_status_id) { ?>
          ...
          <tr>
            ...
            <td><select name="sagepay_direct_geo_zone_id">
                ...
                <? if ($geo_zone['geo_zone_id'] == $sagepay_direct_geo_zone_id) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="sagepay_direct_sort_order" value="<?= $sagepay_direct_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>

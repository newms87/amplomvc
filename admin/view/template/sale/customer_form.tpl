      ...
      <form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <div id="vtabs" class="vtabs"><a href="#tab-customer"><?= $tab_general; ?></a>
            ...
            <a href="#tab-address-<?= $address_row; ?>" id="address-<?= $address_row; ?>"><?= $tab_address . ' ' . $address_row; ?>&nbsp;<img src="view/image/delete.png" alt="" onclick="$('#vtabs a:first').trigger('click'); $('#address-<?= $address_row; ?>').remove(); $('#tab-address-<?= $address_row; ?>').remove(); return false;" /></a>
            <? $address_row++; ?>
            <? } ?>
...
function addTransaction() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#transaction').before('<div class="attention"><img src="view/image/loading.gif" alt="" /> <?= $text_wait; ?></div>');
		},
		complete: function() {
...
function addRewardPoints() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#reward').before('<div class="attention"><img src="view/image/loading.gif" alt="" /> <?= $text_wait; ?></div>');
		},
		complete: function() {

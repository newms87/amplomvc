        ...
        <table class="form">
          <tr>
	       ...
	       <tr>
                <td><?= $entry_headers; ?></td>
                <? foreach ($languages as $language) {?>
                	<td id='language<?= $language['language_id'];?>'><textarea name="layout_header[<?= $language['language_id']; ?>][page_header]" id="header<?= $language['language_id']; ?>"><?= isset($layout_header[$language['language_id']]) ? $layout_header[$language['language_id']]['page_header'] : ''; ?></textarea></td>
                <? } ?>
            </tr>
        </table>
        <br />
...
<? foreach ($languages as $language) { ?>
CKEDITOR.replace('header<?= $language['language_id']; ?>', {

           ...
           <? foreach ($banner_images as $banner_image) { ?>
            <tr class="imagerow" id="image-row<?= $image_row; ?>">
              ...
              <td class="left"><div class="image"><img src="<?= $banner_image['thumb']; ?>" alt="" id="thumb<?= $image_row; ?>" />
                 ...
                 <br />
                 <a onclick="el_uploadSingle('image<?= $image_row; ?>', 'thumb<?= $image_row; ?>',<?= $image_row ?>);"><?= $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb<?= $image_row; ?>').attr('src', '<?= $no_image; ?>'); $('#image<?= $image_row; ?>').attr('value', '');"><?= $text_clear; ?></a></div></td>
...
function addImage(imageName) {    
   ...
   html += '    <td class="left"><div class="image"><img width="100" src="../image/' + imageName + '" alt="' + imageName + '" title="' + imageName + '" id="thumb' + image_row + '" /><input type="hidden" name="banner_image[' + image_row + '][image]" value="' + imageName + '" id="image' + image_row + '" /><br /><a onclick="el_uploadSingle(\'image<?= $image_row; ?>\', \'thumb<?= $image_row; ?>\',<?= $image_row ?>);"><?= $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?= $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');"><?= $text_clear; ?></a></div></td>';

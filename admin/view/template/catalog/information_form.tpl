          ...
          <div id="language<?= $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><textarea name="information_description[<?= $language['language_id']; ?>][description]" id="description<?= $language['language_id']; ?>"><?= isset($information_description[$language['language_id']]) ? $information_description[$language['language_id']]['description'] : ''; ?></textarea>

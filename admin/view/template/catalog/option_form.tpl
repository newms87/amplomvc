             ...
             <? foreach ($option_values as $option_value) { ?>
               <tr class="optionvaluerow" id="option-value-row<?= $option_value_row ?>">
                 ...
                 <td class="left"><div class="image"><img src="<?= $option_value['thumb']; ?>" alt="" id="thumb<?= $option_value_row; ?>" />
                     ...
                     <br />
                     <a onclick="el_uploadSingle('image<?= $option_value_row; ?>', 'thumb<?= $option_value_row; ?>',<?= $option_value_row ?>);"><?= $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb<?= $option_value_row; ?>').attr('src', '<?= $no_image; ?>'); $('#image<?= $option_value_row; ?>').attr('value', '');"><?= $text_clear; ?></a></div></td>
...
function addOptionValue() {
   ...
   html += '<a onclick="el_uploadSingle(\'image' + option_value_row + '\', \'thumb' + option_value_row + '\',' + option_value_row + ');"><?= $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;';

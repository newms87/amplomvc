                ...
                <ol id="featured-product" class="scrollbox p_product_list">
                 <? foreach ($products as $product) { ?>
                    <li id="featured-product<?= $product['product_id']; ?>">
                      ...
                      <img src="view/image/delete.png" onclick="$(this).parent().remove()"/>
                    </li>
                 <? } ?>
                 </ol>
...
function generate_url(c){
   ...
   $.post('index.php?route=catalog/flashsale/generate_url',{flashsale_id:<?=$flashsale_id;?>,name:name},function(json){$('input[name="keyword"]').val(json);},'json');
}
 //--></script>
<script type="text/javascript"><!--
function autofill_designer_info(){
   $.post('index.php?route=catalog/flashsale/get_designer_info',{designer_id:$('#autofill_designer').val()},apply_designer_info,'json');
}
...
function add_featured_product(id,name,price){
      ...
      html +=  '<img src="view/image/delete.png" onclick="$(this).parent().remove()"/>';

          ...
          <td>
             ...
             <? foreach ($featured_product_list as $id => $item) { ?>
               <li item_id='<?=$id;?>'>
                  ...
                  <img class='remove' onclick='$(this).parent().remove();' width='30px' src="view/image/delete.png" />
               </li>
            <? } ?>
            </ul>
        </tr>
...
function add_to_list(selector, data){
   ...
   html += '   <img class="remove" onclick="$(this).parent().remove();" width="30px" src="view/image/delete.png" />';
   html += '</li>';

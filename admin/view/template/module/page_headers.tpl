		      ...
		      <td class='center'>
				...
				<td class="center">
                  ...
                  <div id='languages-<?=$module_row;?>' class="htabs">
                     ...
                     <a href="#language-<?=$module_row;?>-<?=$language['language_id'];?>"><img src="view/image/flags/<?= $language['image']; ?>" title="<?= $language['name']; ?>" /> <?= $language['name']; ?></a>
                     <? } ?>
                  </div>
               <? }?>
...
function addModule() {	
   ...
   <? foreach ($languages as $language) { ?>
   html += '   <a href="#language-%modrow%-<?=$language['language_id'];?>"><img src="view/image/flags/<?= $language['image']; ?>" title="<?= $language['name']; ?>" /> <?= $language['name']; ?></a>';
   <? } ?>
   html += '</div>';
   <? }?>

  ...
  <div class="content">
    <form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <table class="form">
        ...
        <tr>
          ...
          <td><div id="featured-product" class="scrollbox">
              ...
              <div id="featured-product<?= $product['product_id']; ?>" ><?= $product['name']; ?> <img src="view/image/delete.png" />
      ...
      <table id="module" class="list">
        ...
        <? if(isset($module['fm_id']))continue; ?>
...
$('input[name=\'product\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#featured-product').append('<div id="featured-product' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" /><input type="hidden" name="featured_product[]" value="' + ui.item.value + '" /></div>');
...
function add_product_filter_to_list(event){
   ...
   $('.product_filter_item').each(function(i,e){
      if($(e).attr('filter_id') == filter_id){filter_id="";return false;}
   });
   if(filter_id=="")return;

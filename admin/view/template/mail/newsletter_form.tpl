          ...
          <td>
            <ol id="product_list" class="scrollbox editable_list">
              ...
              <li>
                 ...
                 <img onclick="$(this).parent().remove()" src="view/image/delete.png" />
              </li>
              <? } ?>
              <? } ?>
            </ol>
...
$('#add_article_button').click(function(){
   ...
   html += '   </div>';
   html += '   <img onclick="$(this).parent().remove()" src="view/image/delete.png" />';
   html += '</li>';
...
function prepare_preview(){
   ...
   $('#preview_page #preview_window').html('<div style="margin-top:20%;text-align:center">Loading Preview</div><div style="text-align:center"><img src="/admin/view/image/loading_bar.gif" /></div>');

    	...
    	<form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
	     ...
	     <div id='tab-profile'>
	          ...
	          <span id="profile-add">
	          	...
	          	<img src="view/image/add.png" alt="" onclick="addProfile();" />
	          </span>
	       </div>
          <div id="profiles"></div>
        </div>
...
<div id="profile_tab_template" style="display:none">
	<a href="#tab-profile-%pid%" id="profile-%pid%">
    	...
    	<img src="view/image/delete.png" alt="" onclick="$('.vtabs a:first').trigger('click'); $('#profile-%pid%').remove(); $('#tab-profile-%pid%').remove(); return false;" />
    </a>
</div>

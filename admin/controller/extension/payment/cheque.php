<?php
class Admin_Controller_Payment_Cheque extends Controller
{
	...
	public function index()
	{
		...
		if ($this->request->isPost() && $this->validate()) {
			$this->System_Model_Setting->editSetting('cheque', $_POST);
		...
		$this->breadcrumb->add($this->_('head_title'), $this->url->link('payment/cheque'));

...
$this->template->load('report/customer_credit');
		...
		if (isset($_GET['page'])) {
			...
			$this->breadcrumb->add($this->_('heading_title'), $this->url->link('report/customer_credit', $url));
		...
		$this->pagination->url = $this->url->link('report/customer_credit', $url . '&page={page}');

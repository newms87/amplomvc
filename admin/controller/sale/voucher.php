...
class ControllerSaleVoucher extends Controller {
  	...
  	public function insert() {
		...
		if (($_SERVER['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect($this->url->link('sale/voucher', $url));
    	}
...
$this->template->load('sale/voucher_list');
		...
		$this->pagination->url = $this->url->link('sale/voucher', $url . '&page={page}');
...
$this->template->load('sale/voucher_history');
		...
		$this->pagination->url = $this->url->link('sale/voucher/history', 'voucher_id=' . $_GET['voucher_id'] . '&page={page}');

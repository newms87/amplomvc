<?php
class Catalog_Model_Checkout_Fraud extends Model 
{
	public function getFraudScore($data)
	{
		...
		if ($fraud_info) {
			...
			*/
			...
			$request .= '&emailMD5=' . urlencode(md5(strtolower($data['email'])));

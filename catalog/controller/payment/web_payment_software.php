...
$this->template->load('payment/web_payment_software');
	...
	public function send() {
		...
		$request .= '&CC_NUMBER=' . urlencode(str_replace(' ', '', $_POST['cc_number']));
		$request .= '&CC_EXP=' . urlencode($_POST['cc_expire_date_month'] . substr($_POST['cc_expire_date_year'], 2));
		$request .= '&CC_CVV=' . urlencode($_POST['cc_cvv2']);

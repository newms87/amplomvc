<div id='product_options' class="options">
	...
	<div class="product_option" data-po-id="<?= $product_option['product_option_id']; ?>">
		...
		<? switch ($product_option['type']) {
			case 'select': ?>
				<?= $this->builder->build('select', $product_option['product_option_values'], "product_option[$product_option[product_option_id]]"); ?>
				<? break;
			
			case 'radio': ?>
				<?= $this->builder->build('radio', $product_option['product_option_values'],	"product_option[$product_option[product_option_id]]"); ?>
				<? break;
			
			case 'checkbox': ?>
				<?= $this->builder->build('checkbox', $product_option['product_option_values'],	"product_option[$product_option[product_option_id]]"); ?>
				<? break;
					...
					<label for="<?= $id; ?>" class="option_image">
						<div class="option_image_box">
							<? if($product_option_value['thumb']) {?>
								<a title="<?= $product_option_value['value']; ?>" rel="<?= $product_option_value['rel']; ?>" >

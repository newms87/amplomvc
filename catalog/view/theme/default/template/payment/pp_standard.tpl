  ...
  <div class="buttons">
    <div class="right">
      ...
      <div id='processing_payment'>
         <img src="catalog/view/theme/default/image/loading.gif" alt="" /><span><?= $text_processing_payment;?></span><br />
...
function check_order_update(){
   $.ajax({
      url: 'index.php?route=checkout/block/confirm/check_order_status&order_id=<?=$order_id;?>',
      dataType: 'json',

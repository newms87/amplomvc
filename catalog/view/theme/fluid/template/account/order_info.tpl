	...
	<div class="order-info row">
		<div class="wrap">
			...
			<div class="footer-text col xs-12">
				<?= _l("* A Product Marked as Final Sale cannot be returned. Read our <a href=\"%s\" class=\"colorbox\">Return Policy</a> for details.", site_url('information/information/info', 'information_id=' . option('config_shipping_return_info_id'))); ?>
			</div>
		</div>
	</div>

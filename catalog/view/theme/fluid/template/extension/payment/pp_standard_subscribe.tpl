<? if ($testmode) { ?>
	<div class="message-box warning"><?= _l("The PayPal payment method is in sandbox mode. Your account will not be charged."); ?></div>
<? } ?>
...
<form action="<?= $action; ?>" method="post" target="_blank">
	...
	<div class="buttons">
		<div class="right">
			<div id="submit-pp-button"><div id="submit-payment"><?= _l("Submit Payment"); ?></div><input type="submit" value="<?= _l("Confirm"); ?>" class="button" /></div>
			<div id="processing-payment">
				<img src="<?= theme_url('image/loading.gif'); ?>" alt="" /><span><?= _l("Processing Payment"); ?></span><br />

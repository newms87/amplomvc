...
(function($){
	...
	$.fn.dncarousel = function(options) {
		...
		this.each(function(){ $(this).data('dnc', new Carousel($(this), options)); });
		return this;
	};
	
	$.fn.dncarousel_update = function(){ $(this).data('dnc').update(); };
	$.fn.dncarousel_start = function(){ $(this).data('dnc').start(); };
	$.fn.dncarousel_stop = function(){ $(this).data('dnc').stop(); };
	$.fn.dncarousel_move = function(iNum){ $(this).data('dnc').move(iNum-1,true); };
	$.fn.dncarousel_last = function(){ $(this).data('dnc').last(); };
	...
	function Carousel(my_carousel, options){
		...
		function setEvents(){
			...
			if(options.interval){ oViewport.hover(oSelf.stop,oSelf.start); }
		...
		this.last = function(){this.move(iSteps,true);}

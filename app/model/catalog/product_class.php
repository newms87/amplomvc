<?php
class App_Model_Catalog_ProductClass extends Model
{
	...
	public function addProductClass($data)
	{
		...
		$data['App_Controller_Admin'] = !empty($data['App_Controller_Admin']) ? serialize($data['App_Controller_Admin']) : '';
	...
	public function editProductClass($product_class_id, $data)
	{
		...
		if (isset($data['App_Controller_Admin'])) {
			$data['App_Controller_Admin'] = !empty($data['App_Controller_Admin']) ? serialize($data['App_Controller_Admin']) : '';
		}
	...
	public function getProductClass($product_class_id)
	{
		...
		$product_class['App_Controller_Admin'] = unserialize($product_class['App_Controller_Admin']);

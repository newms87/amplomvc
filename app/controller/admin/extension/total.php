...
class App_Controller_Admin_Extension_Total extends Controller
{
	...
	private function getList()
	{
		...
		$this->breadcrumb->add(_l("Order Totals"), site_url('admin/extension/total'));
	...
	private function getForm()
	{
		...
		//Breadcrumbs
		$this->breadcrumb->add(_l("Home"), site_url('admin/common/home'));
		$this->breadcrumb->add(_l("Order Totals Extensions"), site_url('admin/extension/total'));
		$this->breadcrumb->add($total_extension->info('title'), site_url('admin/extension/total', 'code=' . $code));
	...
	public function edit()
	{
		...
		$this->breadcrumb->add(_l("Home"), site_url('admin/common/home'));
		$this->breadcrumb->add(_l("Order Totals Extensions"), site_url('admin/extension/total'));
		$this->breadcrumb->add($extension['title'], site_url('admin/extension/total/edit', 'code=' . $code));

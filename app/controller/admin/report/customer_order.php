<?php
class App_Controller_Admin_Report_CustomerOrder extends Controller
{
	public function index()
	{
		...
		$this->breadcrumb->add(_l("Customer Orders Report"), site_url('admin/report/customer_order', $url));

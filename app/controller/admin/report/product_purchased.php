<?php
class App_Controller_Admin_Report_ProductPurchased extends Controller
{
	public function index()
	{
		...
		$this->breadcrumb->add(_l("Products Purchased Report"), site_url('admin/report/product_purchased', $url));

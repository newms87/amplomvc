			...
			<div class="product-info col xs-12 md-6">
				...
				<div class="tab-contents">
					...
					<div id="tab-shipping-return" class="tab-content">
						...
						<? if (option('config_shipping_return_page_id')) { ?>
							<p>
								<?= _l("Please see our"); ?>
								<a class="colorbox" href="<?= site_url('page/content', 'page_id=' . option('config_shipping_return_page_id')); ?>"><?= _l("Shipping & Return Policy"); ?></a>

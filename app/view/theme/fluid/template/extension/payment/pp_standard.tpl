<? if ($testmode) { ?>
	<div class="message-box warning"><?= _l("This payment method is in sandbox mode. You will not be charged for your purchase"); ?></div>
<? } ?>
<form action="<?= $action; ?>" method="post" target="_blank">
	...
	<div class="buttons">
		<div class="right">
			<div id="submit-pp-button">
				<div id="submit-payment"><?= _l("Submit Payment"); ?></div>

	...
	<div class="content-box col xs-12 lg-8 xl-7 top">
		<div class="content">
			...
			<div class="account-info">
				...
				<div class="forms">
					<form action="<?= site_url('account/save'); ?>" method="post" class="section col xs-12 left" autocomplete="off">
						<div class="heading">
							<h3 class="on-click is-dormant" data-amp-toggle=".form-change-email">
								<span class="text">{{Email}}</span>
								<a class="edit-form on-dormant"><i class="fa fa-pencil"></i></a>
								<a class="cancel-form on-active"><i class="fa fa-close"></i></a>
							</h3>
						</div>

						<div class="form-fields form-change-email is-dormant on-always">
							<div class="row on-dormant left">
								<div class="field email"><?= $customer['email'] ?></div>
							</div>

							<div class="row on-active col xs-12 left">
								<div class="input">

			...
			<div class="homepage-icons">
				<div class="icon col xs-12 sm-4">
					<div class="sprite-img details">
						<img src="<?= theme_image('sprite-16.png'); ?>" alt="<?= _l("My Project"); ?>" title="<?= _l("Siding Project Details"); ?>"/>
					</div>
					<div class="icon-text">
				...
				<div class="icon col xs-12 sm-4">
					<div class="sprite-img contact">
						<img src="<?= theme_image('sprite-16.png'); ?>" alt="<?= _l("Contact Contractor"); ?>" title="<?= _l("Siding Project Contact"); ?>"/>
					</div>
					<div class="icon-text">
				...
				<div class="icon col xs-12 sm-4">
					<div class="sprite-img quote">
						<img src="<?= theme_image('sprite-16.png'); ?>" alt="<?= _l("Contactor Quote"); ?>" title="<?= _l("Siding Project Quote"); ?>"/>
					</div>
					<div class="icon-text">
			...
			<div class="metro-icons col xs-12">
				<div class="icon">
					<div class="sprite-img handshake">
						<img src="<?= theme_image('sprite-16.png'); ?>" alt="<?= _l("Tailored"); ?>" title="<?= _l("Match your needs"); ?>"/>
					</div>
					<div class="icon-text">
				...
				<div class="icon">
					<div class="sprite-img hardhat">
						<img src="<?= theme_image('sprite-16.png'); ?>" alt="<?= _l("High Quality"); ?>" title="<?= _l("Quality Siding Workmanship"); ?>"/>
					</div>
					<div class="icon-text">
				...
				<div class="icon">
					<div class="sprite-img trusted">
						<img src="<?= theme_image('sprite-16.png'); ?>" alt="<?= _l("Satisfied Customers"); ?>" title="<?= _l("Just ask our customers!"); ?>"/>
					</div>
					<div class="icon-text">
				...
				<div class="icon">
					<div class="sprite-img strong-arm">
						<img src="<?= theme_image('sprite-16.png'); ?>" alt="<?= _l("Reliable"); ?>" title="<?= _l("We are there for you"); ?>"/>
					</div>
					<div class="icon-text">
				...
				<div class="icon">
					<div class="sprite-img hour-glass">
						<img src="<?= theme_image('sprite-16.png'); ?>" alt="<?= _l("Long-Term"); ?>" title="<?= _l("Long-Term Customers!"); ?>"/>
					</div>
					<div class="icon-text">

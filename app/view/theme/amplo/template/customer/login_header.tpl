<div class="login_header">
	<div id="one_click">
		<? if (!empty($gp_login)) { ?>
			<a href="<?= $gp_login; ?>" class="fa fa-google-plus-square small" title="{{Sign in with Google+}}"></a>
		<? } ?>

		<? if (!empty($fb_login)) { ?>
			<a href="<?= $fb_login; ?>" class="fa fa-facebook-square small" title="{{Sign in with Facebook}}"></a>
		<? } ?>
	</div>

						...
						<div class="acm-contact row left" data-row="__ac_template__" data-template-root="true">
							<div class="acm-fields row left">
								...
								<label for="contact-cb-__ac_template__" class="acm-contact-info col auto left">
									...
									<div class="acm-field template-id">
										<span class="label">{{Template:}}</span>
										<span class="value" data-name="template_id" data-type="select"></span>
									</div>
								</label>
							</div>
							...
							<div class="acm-contact-form hidden">
								...
								<div class="contact-details col xs-12 sm-8 md-6 left top">
									...
									<div class="form-item template-id">
										<label class="select">
											<?= build(array(
												'type'  => 'select',
												'name'  => 'template_id',
												'data'  => array('' => '(Default Template)') + $r->Model_Doc->getUserTemplates(customer_info('customer_id'), 'estimate'),
												'label' => 'name',
												'value' => 'template_id',
											)); ?>
										</label>
								...
								<div class="col md-visible md-6 col-spacer"></div>

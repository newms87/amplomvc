...
class Length extends Library
{
	...
	public function __construct()
	{
		...
		$length_class_query = $this->query("SELECT * FROM " . DB_PREFIX . "length_class mc LEFT JOIN " . DB_PREFIX . "length_class_description mcd ON (mc.length_class_id = mcd.length_class_id) WHERE mcd.language_id = '" . (int)option('config_language_id') . "'");

...
class Builder extends Library
{
	...
	{
		$final_sale_explanation = _l("A Product Marked as <span class='final_sale'></span> cannot be returned. Read our <a href=\"%s\" onclick=\"return colorbox($(this));\">Return Policy</a> for details.", site_url('information/information/info', 'information_id=' . option('config_shipping_return_info_id')));

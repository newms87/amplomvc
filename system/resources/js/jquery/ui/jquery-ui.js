...
(function (t, e) {
	...
	t.widget("ui.autocomplete", {
		...
		options:       {
			...
			var e;
			this._superApply(arguments), this.options.disabled || this.cancelSearch || (e = t && t.length ? this.options.message.results(t.length) : this.options.message.noResults, this.liveRegion.text(e))
		}
	})
}(jQuery), function (t) {

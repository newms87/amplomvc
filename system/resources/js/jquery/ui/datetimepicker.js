(function ($) {
			...
			if (e.find("div.ui-timepicker-div").length === 0 && t.showTimepicker) {
				...
				for (f = 0, l = n.units.length; f < l; f++) {
					...
					if (s && t[r + "Grid"] > 0) {
						...
						g.find(".ui_tpicker_" + r + " table").css({
							width:          a + "%",
							marginLeft:     t.isRTL ? "0" : a / (-2 * u[r]) + "%",
							marginRight:    t.isRTL ? a / (-2 * u[r]) + "%" : "0",
						...
						if (g.find(".ui-slider-access").length === 0) {
							...
							if (e) {
								g.find("table:visible").each(function () {
									var t = $(this), n = t.outerWidth(), r = t.css(S ? "marginRight" : "marginLeft").toString().replace("%", ""), i = n - e, s = r * i / n + "%", o = {
										width: i,
										marginRight: 0,
										marginLeft: 0
									};
	...
	$.datepicker.parseTime = function (e, t, n) {
		...
		var s = function (e, t, n) {
			...
			var i = function (e) {
				var t = e.toLowerCase().match(/(h{1,2}|m{1,2}|s{1,2}|l{1}|c{1}|t{1,2}|z|'.*?')/g), n = {
					h: -1,
					m: -1,
					s: -1,
					l: -1,
		...
		var o = function (e, t, n) {
			try {
				...
				return {
					...
					microsec: r.getMicroseconds(),
					timezone: r.getTimezoneOffset() * -1
				}
			} catch (i) {
				try {
					return s(e, t, n)
